# ⚡ JADICMS: Laravel Power, Inertia Speed. The Modern Stack, Simplified.

[![Build Status](https://img.shields.io/badge/Status-Development-orange)](https://github.com/jstalinko/jadicms)
[![Laravel Version](https://img.shields.io/badge/Laravel-12.x-red)](https://laravel.com/)
[![License](https://img.shields.io/badge/License-MIT-blue)](LICENSE)
[![Contributors](https://img.shields.io/github/contributors/jstalinko/jadicms)](https://github.com/jstalinko/jadicms/graphs/contributors)

JADICMS adalah Sistem Manajemen Konten (CMS) modern yang dirancang untuk kecepatan, efisiensi developer, dan pengalaman pengguna yang luar biasa. Dibangun di atas fondasi ekosistem Laravel yang kuat, JADICMS menyatukan teknologi **VILT** (Vue, Inertia, Laravel, Tailwind) dengan Panel Administrasi **Filament** yang elegan.
